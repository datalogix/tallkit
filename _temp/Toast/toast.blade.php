...
>
    <template x-for="position in positions" :key="position">
        <div
            {{ $attributesAfter('position:')->classes('absolute flex flex-col') }}
            :class="{
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <div
                        x-show="progress"
                        {{ $attributesAfter('progress:')->classes('bg-black/5 dark:bg-black/10 h-full absolute inset-0 pointer-events-none origin-left') }}
