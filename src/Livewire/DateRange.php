...
class DateRange extends CarbonPeriod
{
    ...
    public static function fromPreset(DateRangePreset $preset)
    {
    ...
    public static function nextQuarter()
    {
    ...
    public static function next14Days()
    {
    ...
    public static function next3Months()
    {
        return static::fromPreset(DateRangePreset::Next3Months);
    }

    public static function next6Months()
    {
