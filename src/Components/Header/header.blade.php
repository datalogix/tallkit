...
<header {{
    $attributes
        ...
        ->classes(match ($variant) {
            ...
            'strong' => 'bg-zinc-800/15 dark:bg-black [:where(&)]:text-zinc-900 [:where(&)]:dark:text-white',
            'subtle' => 'bg-zinc-700/5 dark:bg-zinc-800/50 [:where(&)]:text-zinc-700/70 [:where(&)]:dark:text-white/70',
            'ghost' => 'bg-transparent [:where(&)]:text-zinc-800/85 [:where(&)]:dark:text-white/85',
            default => 'bg-zinc-700/10 dark:bg-zinc-800 [:where(&)]:text-zinc-800/85 [:where(&)]:dark:text-white/85',
