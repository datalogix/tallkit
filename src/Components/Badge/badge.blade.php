<div {{ $attributes
    ->classes('inline-flex items-center font-medium whitespace-nowrap')
    ->classes('[print-color-adjust:exact]')
    ->classes(match ($size) {
        'lg' => 'text-sm py-1.5 space-x-2',
        'md' => 'text-sm py-1 space-x-1.5',
        default => 'text-sm py-1 space-x-1.5',
        'sm' => 'text-xs py-1 space-x-1',
    })
    ...
    ->when($variant === 'solid',
        fn($c) => $c->classes(match ($color) {
            default => 'text-white dark:text-white bg-gray-600 dark:bg-gray-600 [&:is(button)]:hover:bg-gray-700 dark:[button]:hover:bg-gray-500',
            ...
            'amber' => 'text-white dark:text-gray-950 bg-amber-500 dark:bg-amber-500 [&:is(button)]:hover:bg-amber-600 dark:[button]:hover:bg-amber-400',
            'yellow' => 'text-white dark:text-gray-950 bg-yellow-500 dark:bg-yellow-400 [&:is(button)]:hover:bg-yellow-600 dark:[button]:hover:bg-yellow-300',
        ...
        fn($c) => $c->classes(match ($color) {
            default => 'text-gray-700 [&_button]:text-gray-700! dark:text-gray-200 dark:[&_button]:text-gray-200! bg-gray-400/15 dark:bg-gray-400/40 [&:is(button)]:hover:bg-gray-400/25 dark:[button]:hover:bg-gray-400/50',
