...
$classes = TALLKit::classes()
    ...
    ->add([
        // With the external bnorders, let's always make sure the first and last children have outside borders.
        ...
        // All inputs borders...
        '[&>[data-flux-input]:last-child:ot(:first-child)>[data-flux-group-target]:not([data-invalid])]:border-s-0',
...
<div {{ $attributes->classes($classes) }}>
    {{ $slot }}
</div>
