<div {{ $attributes->classes(
    ...
    '[&:has(>[data-tallkit-radio-group][disabled])>[data-tallkit-label]]:opacity-50',
    '[&:has(>[data-tallkit-checkbox-group][disabled])>[data-tallkit-label]]:opacity-50',
    match ($variant) {
        default => 'block',
        'inline' => '
    ...
    match ($align) {
        ...
        'justify-right' => 'has-[[data-tallkit-label]~[data-tallkit-control]]:grid-cols-[1fr_auto]',
        'justify-left' => 'has-[[data-tallkit-control]~[data-tallkit-label]]:grid-cols-[1fr_auto]',
        default => '',
    },
    match ($variant) {
        default => '
